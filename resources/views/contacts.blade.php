...
<div class="container" style="margin-top: 50px;">
    ...
    <h4 class="text-center">Laravel + Firebase</h4><br>

    <h5># Add Contacts</h5>
    <div class="card card-default">
        <div class="card-body">
            <form id="addContact" class="form-inline" method="POST" action="">
                ...
                <button id="submitContact" type="button" class="btn btn-primary mb-2">Submit</button>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="width:55%;">
            <div class="modal-content" style="overflow: hidden;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success updateContact">Update
                    </button>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#submitContact').on('click', function () {
        var values = $("#addContact").serializeArray();
        ...
        firebase.database().ref('contacts/' + userID).set({
            name: name,
            email: email,
        });
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('contacts/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateContact').on('click', function () {
        ...
        var updates = {};
        updates['/contacts/' + updateID] = postData;
